...
const HOME_TOOLS = [
  ...
  { name: "wash", description: "洗澡", effects: { hygiene: 100, happiness: 5 }, duration: 2, condition: "hygiene < 80" },
  { name: "cook", description: "做饭（免费）", effects: { hunger: 50, energy: 10 }, duration: 3 },
];
...
export const TEST_LOCATIONS: Location[] = [
  ...
  { id: "cafe", name: "咖啡馆", type: "commercial", summary: "喝咖啡、吃东西", openHours: { open: 7, close: 22 }, presentCharacters: [], tools: [
    ...
    { name: "drink", description: "喝咖啡（8金币）", effects: { energy: 5, happiness: 8 }, cost: 8, duration: 2 },
  ] },
  ...
  { id: "beach", name: "海边", type: "nature", presentCharacters: [], tools: [
    { name: "swim", description: "游泳", effects: { energy: -10, happiness: 15 }, duration: 4 },
  ] },
  ...
  { id: "library", name: "图书馆", type: "public", openHours: { open: 9, close: 18 }, presentCharacters: [], tools: [
    { name: "read", description: "看书", effects: { happiness: 10 }, duration: 4 },
  ] },
];
