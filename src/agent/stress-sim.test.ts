...
const CHARACTERS: CharacterCard[] = [
  ...
  {
    id: "anon", name: "千早爱音", age: 19, occupation: "咖啡馆兼职",
    home: "home_anon",
  ...
  {
    id: "mutsumi", name: "要乐奏", age: 19, occupation: "杂货店帮工",
    home: "home_mutsumi",
    personality: { traits: ["温和", "包容"], interests: ["吉他", "做饭"], dislikes: ["争吵"], speechStyle: "温柔平稳" },
    background: "乐器店老板的女儿，性格温和的调解者",
    relationships: {},
  },
  {
    id: "soyo", name: "长崎素世", age: 19, occupation: "图书馆管理员",
    home: "home_soyo",
