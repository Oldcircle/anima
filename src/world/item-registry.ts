...
const CONSUMABLES: ItemDef[] = [
  // 面包店
  { id: "bread_plain", name: "白面包", type: "consumable", value: 5, stackable: true, effects: { hunger: 35 }, traits: ["food", "basic"], perishTicks: 192 },
  { id: "bread_red_bean", name: "红豆面包", type: "consumable", value: 8, stackable: true, effects: { hunger: 45, fun: 3 }, traits: ["food", "sweet"], perishTicks: 192 },
  { id: "croissant", name: "可颂", type: "consumable", value: 10, stackable: true, effects: { hunger: 40, fun: 5 }, traits: ["food", "pastry"], perishTicks: 192 },
  // 咖啡馆
  ...
  { id: "sandwich", name: "三明治", type: "consumable", value: 12, stackable: true, effects: { hunger: 55, fun: 3 }, traits: ["food"], perishTicks: 96 },
  { id: "cake_slice", name: "蛋糕", type: "consumable", value: 15, stackable: true, effects: { hunger: 25, fun: 10 }, traits: ["food", "sweet", "treat"], perishTicks: 96 },
  { id: "sugar_cube", name: "方糖", type: "consumable", value: 2, stackable: true, effects: { hunger: 5, fun: 8, energy: 5 }, traits: ["food", "sweet", "small"], description: "一小盒方糖，可以直接吃，也可以加进咖啡" },
  // 酒吧
  ...
  // 杂货店
  { id: "bento", name: "便当", type: "consumable", value: 10, stackable: true, effects: { hunger: 60, fun: 3 }, traits: ["food", "prepared"], perishTicks: 96 },
  ...
  { id: "fruit_candy", name: "水果糖", type: "consumable", value: 3, stackable: true, effects: { hunger: 5, fun: 8 }, traits: ["food", "sweet", "small", "portable"] },
  { id: "medicine", name: "感冒药", type: "consumable", value: 12, stackable: true, effects: {}, traits: ["medicine"], description: "一板感冒药，着凉了吃一次就见好" },
  // 自制
  { id: "home_cooked_meal", name: "家常饭", type: "consumable", value: 5, stackable: false, effects: { hunger: 75, fun: 5 }, traits: ["food", "homemade"], perishTicks: 96 },
  { id: "fresh_vegetables", name: "新鲜蔬菜", type: "consumable", value: 6, stackable: true, effects: { hunger: 30, fun: 3 }, traits: ["food", "fresh", "homegrown"], description: "自己菜地里种出来的蔬菜，水灵灵的", perishTicks: 288 },
  { id: "fresh_fish", name: "鲜鱼", type: "consumable", value: 8, stackable: true, effects: { hunger: 30 }, traits: ["food", "raw", "fresh"], description: "刚钓上来的鱼", perishTicks: 96 },
];
...
const MATERIALS: ItemDef[] = [
  ...
  { id: "vegetable_seeds", name: "蔬菜种子", type: "material", value: 4, stackable: true, usedBy: ["plant_crop"], traits: ["farm", "raw"], description: "一小包蔬菜种子，种在农田里两天就能收" },
];
