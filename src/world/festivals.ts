...
export interface Festival {
  ...
  promptHint: string;
  /** 对所有角色的效果 */
  effects: Array<{ field: "fun" | "social"; delta: number }>;
}
...
export const FESTIVALS: Festival[] = [
  {
    ...
    effects: [{ field: "fun", delta: 15 }, { field: "social", delta: 10 }],
  },
  {
    id: "fishing_derby",
    name: "钓鱼大赛",
    ...
    effects: [{ field: "fun", delta: 10 }, { field: "social", delta: 15 }],
  },
  {
    id: "harvest_feast",
    name: "丰收宴",
    ...
    effects: [{ field: "fun", delta: 20 }, { field: "social", delta: 20 }],
  },
  {
    id: "lantern_night",
    name: "灯笼之夜",
